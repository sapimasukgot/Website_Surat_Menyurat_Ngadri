...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" name="kode_surat" class="form-control text-uppercase <?php $__errorArgs = ['kode_surat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<div class="form-group">
    ...
    <textarea name="deskripsi" rows="2" class="form-control"><?php echo e(old('deskripsi', $jenisSurat->deskripsi)); ?></textarea>
</div>

<div class="form-group">
    <label>Template Surat (.docx)</label>
    <div class="custom-file">
        <input type="file" name="template" id="template" class="custom-file-input <?php $__errorArgs = ['template'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($jenisSurat->hasTemplate()): ?>
        <small class="text-muted">Template saat ini: <a href="<?php echo e(route('jenis-surat.template', $jenisSurat)); ?>"><?php echo e($jenisSurat->template_original_name); ?></a>. Unggah berkas baru untuk mengganti.</small>
    <?php endif; ?>
...
<table class="table table-sm" id="fields-table">
    ...
    <tbody>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                <td><input type="text" name="fields[<?php echo e($i); ?>][label]" class="form-control form-control-sm" value="<?php echo e($f['label'] ?? ''); ?>"></td>
                <td>
                ...
                <td><input type="checkbox" name="fields[<?php echo e($i); ?>][required]" value="1" <?php if($f['required'] ?? false): echo 'checked'; endif; ?>></td>
...
<div class="form-group mt-3">
    <div class="custom-control custom-switch">
        <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" <?php if(old('is_active', $jenisSurat->is_active ?? true)): echo 'checked'; endif; ?>>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\USer\Website_Surat_Menyurat_Ngadri\resources\views/jenis_surat/_form.blade.php ENDPATH**/ ?>