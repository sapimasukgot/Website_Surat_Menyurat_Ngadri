    ...
    <div class="feature-card">
        ...
        <div class="feature-card-header">
            ...
            <div class="d-flex align-items-center" style="gap: 0.5rem;">
                ...
                <a href="<?php echo e(route('surat.import.form')); ?>" class="header-btn btn-import">
                    <i class="fas fa-file-import"></i> Import
                </a>
                <a href="<?php echo e(route('surat.export', request()->query())); ?>" class="header-btn btn-export"
                    title="Backup riwayat surat ke Excel (mengikuti filter yang sedang aktif)">
                    <i class="fas fa-file-excel"></i> Export
                </a>
                <a href="<?php echo e(route('surat.export.zip', request()->query())); ?>" class="header-btn btn-export"
                    title="Unduh semua berkas Word surat sebagai ZIP (mengikuti filter yang sedang aktif)">
