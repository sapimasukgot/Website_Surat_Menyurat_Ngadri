...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="penandatangan_role" class="form-control">
                                <option value="kepala_desa" <?php if(old('penandatangan_role', 'kepala_desa') === 'kepala_desa'): echo 'selected'; endif; ?>>
                                    Kepala Desa — <?php echo e($penandatanganList['kepala_desa'] ?: 'belum diatur'); ?>

                                </option>
                                <option value="sekretaris_desa" <?php if(old('penandatangan_role') === 'sekretaris_desa'): echo 'selected'; endif; ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AhsanDz\Claude\Projects\Surat_menyurat_Ngadri\resources\views/surat/create.blade.php ENDPATH**/ ?>