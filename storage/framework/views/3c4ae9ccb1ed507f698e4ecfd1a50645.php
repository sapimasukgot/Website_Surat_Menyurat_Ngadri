            ...
            <tr>
                ...
                <td>
                    <select name="fields[<?php echo e($i); ?>][type]" class="form-control form-control-sm">
                        <?php $__currentLoopData = ['text' => 'Teks', 'textarea' => 'Teks Panjang', 'date' => 'Tanggal', 'number' => 'Angka', 'anak_kk' => 'Anak (satu KK)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\AhsanDz\Claude\Projects\Surat_menyurat_Ngadri\resources\views/jenis_surat/_form.blade.php ENDPATH**/ ?>