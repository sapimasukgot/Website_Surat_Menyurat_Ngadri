...
<head>
    ...
    <title>Cetak — <?php echo e($surat->nomor_surat); ?></title>
...
<body>
    <div id="toolbar">
        <span class="title">Cetak Surat &mdash; <?php echo e($surat->nomor_surat); ?></span>
        <span class="spacer"></span>
        <button id="btn-print" onclick="window.print()" disabled>Cetak (Ctrl+P)</button>
        <a class="ghost" href="<?php echo e(route('surat.download', $surat)); ?>">Unduh .docx</a>
        <a class="ghost" href="<?php echo e(route('surat.show', $surat)); ?>">Tutup</a>
    </div>
    ...
    <script>
        const docxUrl = <?php echo json_encode($docxUrl, 15, 512) ?>;
        ...
        fetch(docxUrl, { credentials: 'same-origin' })
            ...
            .catch(function (err) {
                statusEl.innerHTML = 'Gagal memuat surat: ' + err.message +
                    '<br><a style="color:#fff" href="<?php echo e(route('surat.download', $surat)); ?>">Unduh .docx</a>';
            });
    </script>
</body>

</html>
<?php /**PATH C:\Users\AhsanDz\Documents\GitHub\Website_Surat_Menyurat_Ngadri\resources\views/surat/print.blade.php ENDPATH**/ ?>