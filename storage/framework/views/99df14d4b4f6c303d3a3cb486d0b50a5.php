...
<div class="form-row">
    ...
    <div class="form-group col-md-2">
        ...
        <select name="golongan_darah" class="form-control">
            <option value="">—</option>
            <?php $__currentLoopData = \App\Models\Penduduk::GOLONGAN_DARAH; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($g); ?>" <?php if(old('golongan_darah', $penduduk->golongan_darah) === $g): echo 'selected'; endif; ?>><?php echo e($g); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
</div>
...
<div class="form-row">
    ...
    <div class="form-group col-md-3">
        ...
        <select name="status_hubungan" class="form-control">
            <option value="">— Pilih —</option>
            <?php $__currentLoopData = \App\Models\Penduduk::STATUS_HUBUNGAN; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($sh); ?>" <?php if(old('status_hubungan', $penduduk->status_hubungan) === $sh): echo 'selected'; endif; ?>><?php echo e($sh); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
    <div class="form-group col-md-3">
...
<div class="form-row">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" name="nama_ayah" class="form-control" value="<?php echo e(old('nama_ayah', $penduduk->nama_ayah)); ?>"
            placeholder="Nama ayah kandung">
    </div>
    <div class="form-group col-md-4">
        <label>Nama Ibu</label>
        <input type="text" name="nama_ibu" class="form-control" value="<?php echo e(old('nama_ibu', $penduduk->nama_ibu)); ?>"
...
</div><?php /**PATH C:\Users\AhsanDz\Claude\Projects\Surat_menyurat_Ngadri\resources\views/penduduk/_form.blade.php ENDPATH**/ ?>